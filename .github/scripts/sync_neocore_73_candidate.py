...
def sync_root_version_surface(text):
    ...
    text=text.replace('#innova_n--neocore-pre-73--neodialéctica--neodialectics--neodialectica-framework','#innova_n--neocore-73-candidate--neodialéctica--neodialectics--neodialectica-framework')
    return text
...
print('NEOCORE_73_CANDIDATE_NAV=SYNCED_BATCH03B')
