...
def numbered_sections(s):
    """A numbered semantic H2 ends at the next H2 of any kind.

    This avoids charging unnumbered Open Synthesis/navigation tails to the
    final numbered section and removes a documented source of false positives.
    """
...
def section_diagnostics(es_body, en_body):
    """Return material failures and structural warnings separately."""
    material=[]
    warnings=[]
