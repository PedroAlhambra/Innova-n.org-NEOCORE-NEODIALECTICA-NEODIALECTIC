# Fuente canónica de sincronización de la Wiki
# Canonical Wiki synchronisation source

Este directorio conserva en el repositorio principal las versiones trazables de las páginas que deben mantenerse sincronizadas con la Wiki pública de GitHub.

This directory preserves traceable versions of the pages that must remain synchronised with the public GitHub Wiki.
