...
La Filosofía Arquetípica Neodialéctica™ trabaja con memoria, relaciones, contradicciones, perspectivas, límites, genealogía, evidencia, arquetipos y síntesis revisable. Su vector general es el **Bien Común**.
...
NEOCore™ nombra la arquitectura simbiótica de memoria, relación, contraste, síntesis y continuidad del marco. La documentación pública no equivale a la implementación interna completa: conserva la parte que puede publicarse con procedencia, límites y trazabilidad.

Para entender sus relaciones, consulta:
...
La dirección humana, la autoría, la responsabilidad y la genealogía no se disuelven por utilizar IA. La IA puede ampliar memoria, relación, contraste, simulación y capacidad de revisión, pero una salida de IA no se convierte automáticamente en verdad, canon ni soberanía.

## Cómo leer el núcleo sin reducirlo
...
NEOAXIOMAS™
→ principios de alta estabilidad abiertos a revisión
...
WEB4™
→ proyección e interfaz pública
```

Cada término tiene relaciones con los demás, pero ninguno equivale por sí solo al Todo.
...
Archetypal Neodialectical Philosophy™ works with memory, relations, contradictions, perspectives, limits, genealogy, evidence, archetypes and revisable synthesis. Its general vector is the **Common Good**.
...
NEOCore™ names the framework's symbiotic architecture of memory, relation, challenge, synthesis and continuity. Public documentation is not equivalent to the complete internal implementation: it preserves the layer that can be published with provenance, limits and traceability.

To understand its relations, consult:
...
Human direction, authorship, responsibility and genealogy are not dissolved by the use of AI. AI may expand memory, relation, challenge, simulation and review capacity, but an AI output does not automatically become truth, canon or sovereignty.

## How to read the core without reducing it
...
WEB4™
→ public projection and interface
```

Each term has relations with the others, but none of them alone is equivalent to the Whole.
