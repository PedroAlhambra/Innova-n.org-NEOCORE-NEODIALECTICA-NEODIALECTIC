...
**Relación genealógica / Genealogical relation:** desarrolla una formulación ya presente en el análisis público *Religión, identidad, dogma y conciencia*, donde la Neodialéctica se propone como punto de encuentro entre culturas capaz de conservar diferencia, superar fragmentación y construir una arquitectura común. Se relaciona directamente con [Síntesis Abierta Neodialéctica™](canonicos/II_sintesis_abierta_neodialectica_ES_EN.md), [Neodialéctica™](canonicos/IV_neodialectica_bien_comun_ES_EN.md) y Bien Común, [I](canonicos/I_neo0_soberania_de_guia_ES_EN.md)ngeniería Social Abierta y Psicohistoria Neodialéctica, Memoria-Genealogía-Trazabilidad, [Refragmentación Arquetípica™](canonicos/XVI_refragmentacion_arquetipica_ES_EN.md), [Reversión Ideológica™](canonicos/XXXII_reversion_ideologica_neodialectica_mcluhan_neo0_ES_EN.md), [Neofraternidad™](canonicos/XXXVII_neofraternidad_ES_EN.md), [Multidimensionalidad Neodialéctica™](canonicos/XLV_multidimensionalidad_neodialectica_problema_mulo_soberania_distribuida_ES_EN.md) y [La Síntesis Todo lo Ve™](canonicos/XLVIII_sintesis_todo_lo_ve_placa_petri_universal_maquina_fractal_tiempo_ES_EN.md).  
