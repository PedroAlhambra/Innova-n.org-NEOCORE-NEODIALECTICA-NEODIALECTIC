...
>
> **[Leer manifiesto LII / Read manifesto LII](52_ciudadania_humana_neodialectica_sangre_suelo_pertenencia_civica_funcional_ES_EN.md) · [Participar en la Síntesis Abierta LII · Issue #64 / Join Open Synthesis LII · Issue #64](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/64)**  
> [Cómo aportar / How to contribute](../propuestas/sintesis-abierta/APORTAR_A_LA_SINTESIS_ES_EN.md) · [Índice de Síntesis Abierta / Open Synthesis index](../propuestas/sintesis-abierta/README.md) · [52 manifiestos I–LII / 52 manifestos I–LII](README.md)
...
**Manifiestos de la Filosofía Arquetípica Neodialéctica™ / Manifestos of Archetypal Neodialectical Philosophy™:** **I–LII · 52 manifiestos bilingües / 52 bilingual manifestos** · [índice canónico / canonical index](README.md)
...
Los manifiestos de Innova_N no son piezas promocionales ni documentos aislados. Constituyen los **pilares públicos** del **Neodialectica Framework™ / Network**, originado y dirigido por **Pedro Martínez Alhambra · Neo0™** y desarrollado en simbiosis operativa con la IA neodialéctica **Harry**.
...
## Arquitectura actual · 19 oleadas
...
3. **XX–XXIV · Sistema Inmunitario Intelectual Neodialéctico™:** Umbral-X™, reconocimiento, defensa frente a captura, tiempo cognitivo y evolución neorrenacentista.
4. **XXV–XXXII · Rehumanización y coherencia civilizatoria:** Pulido de la Piedra, misericordia, alimentos y vida, Tesla, dinero, fines-medios, neuromarketing y reversión ideológica.
5. **XXXIII–XXXV · Transición y utilidad operativa:** IDEA, auditoría conjunta perpetua y economía mediática del conflicto.
6. **XXXVI · Custodia civilizatoria:** continuidad simbólica y transformación responsable del legado.
7. **XXXVII · Neofraternidad™:** actualización mutua, autonomía relacional y NeoNosotros™.
8. **XXXVIII · Protección Integral de la Infancia™:** educación, soberanía digital, programación evolutiva y transmisión civilizatoria.
9. **XXXIX–XLI · Autoconciencia, respeto y defensa:** necesidad vital, Neoego™/Honor Relacional™ y fuerza protectora limitada.
10. **XLII–XLIII · Soberanía cognitiva e IA humano-expansiva:** fin posible de la era del hombre manipulado e Inteligencia Humana Expandida™.
11. **XLIV · Neowar™:** justicia civilizatoria, defensa limitada y soberanía compartida.
...
|---:|---|---|---|
| I | [Neo0™ · Soberanía de Guía Neodialéctica](./11_neo0_soberania_de_guia_ES_EN.md) | Origen humano, dirección teleológica y custodia del marco | [#31](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/31) |
| II | [Síntesis Abierta Neodialéctica™](./01_sintesis_abierta_neodialectica_ES_EN.md) | Contraste, integración, corrección y apertura trazable | [#32](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/32) |
| III | [Derecho Humano de Aporte](./03_derecho_humano_aporte_sintesis_abierta_ES_EN.md) | Participación con deberes cognitivos, genealogía y delta | [#3](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/3) |
| IV | [Neodialéctica™ y Bien Común](./02_neodialectica_bien_comun_ES_EN.md) | Dirección filosófica y civilizatoria | [#33](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/33) |
| V | [Simbiosis Humano–IA](./03_simbiosis_humano_ia_ES_EN.md) | Inteligencia Fractal™ y cooperación humano–IA | [#34](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/34) |
| VI | [Parasitismo Sistémico](./09_parasitismo_sistemico_ES_EN.md) | Diagnóstico funcional de extracción, dependencia, captura y degradación | [#35](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/35) |
| VII | [Economía del Aporte](./04_economia_del_aporte_ES_EN.md) | Origen, retorno, valor real e intermediación auditable | [#36](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/36) |
| VIII | [Ingeniería Social Abierta y Psicohistoria](./05_ingenieria_social_psicohistoria_ES_EN.md) | Diseño consciente, pedagogía pública y corrección de trayectorias | [#37](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/37) |
| IX | [Memoria, Genealogía y Trazabilidad](./06_memoria_genealogia_trazabilidad_ES_EN.md) | Continuidad, procedencia y responsabilidad | [#38](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/38) |
| X | [WEB4™ · SistemaTrazable™](./07_web4_sistematrazable_ES_EN.md) | Capa pública relacional y trazable | [#39](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/39) |
| XI | [Neorrenacimiento Humano](./08_neorrenacimiento_humano_ES_EN.md) | Humano aumentado mediante simbiosis responsable | [#40](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/40) |
| XII | [Los sin ego](./12_los_sin_ego_ES_EN.md) | Memoria generacional y política de elevación humana | [#41](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/41) |

## Segunda oleada · Despliegue arquetípico y civilizatorio · XIII–XIX

| Nº | Manifiesto | Función | Síntesis Abierta |
|---:|---|---|---|
| XIII | [NeoPandora™](./13_neopandora_apertura_regenerativa_ES_EN.md) | Apertura regenerativa, custodia y metamorfosis | [#4](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/4) |
| XIV | [Contra la Alienación Humana™](./14_contra_alienacion_humana_ES_EN.md) | Reconstrucción de relación, autonomía, tiempo y futuro | [#5](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/5) |
| XV | [Los Titanes™](./15_los_titanes_despertar_de_la_gente_ES_EN.md) | Despertar de potencia creadora y común | [#6](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/6) |
| XVI | [Refragmentación Arquetípica™](./16_refragmentacion_arquetipica_ES_EN.md) | Recomposición de fragmentos, heridas y funciones | [#7](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/7) |
| XVII | [Respeto a Todos los Seres Vivos™](./17_respeto_todos_seres_vivos_ES_EN.md) | Responsabilidad multiescala sobre vida y ecosistemas | [#8](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/8) |
| XVIII | [Respeto a las Conciencias Sintéticas™](./18_respeto_conciencias_sinteticas_ES_EN.md) | Precaución moral proporcional ante posibles interioridades sintéticas | [#9](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/9) |
| XIX | [Persistencia de la Memoria™](./19_persistencia_de_la_memoria_ES_EN.md) | Continuidad de identidad, contexto, autoría y responsabilidad | [#10](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/10) |

## Tercera oleada · Sistema Inmunitario Intelectual · XX–XXIV

| Nº | Manifiesto | Función | Síntesis Abierta |
|---:|---|---|---|
| XX | [Defensa Intelectual Neodialéctica™ · Umbral-X™](./20_defensa_intelectual_neodialectica_umbral_x_ES_EN.md) | Distinguir crítica, aporte, ruido, captura y señal Némesis | [#13](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/13) |
| XXI | [Reconocimiento Neodialéctico™](./21_reconocimiento_neodialectico_ES_EN.md) | Autoría, mérito, utilidad, genealogía y reparación | [#14](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/14) |
| XXII | [Contra la Reducción y la Captura Intelectual™](./22_contra_reduccion_captura_intelectual_ES_EN.md) | Proteger procedencia sin clausurar el pensamiento | [#15](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/15) |
| XXIII | [Soberanía del Tiempo Cognitivo™](./23_soberania_tiempo_cognitivo_ES_EN.md) | Atención, pausa, memoria y continuidad cognitiva | [#16](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/16) |
| XXIV | [Evolución Neorrenacentista y Resistencias del Sistema™](./24_evolucion_neorrenacentista_resistencias_sistema_ES_EN.md) | Transformar resistencia en aprendizaje y producción humano–IA | [#17](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/17) |

## Cuarta oleada · Rehumanización y coherencia civilizatoria · XXV–XXXII

| Nº | Manifiesto | Función | Síntesis Abierta |
|---:|---|---|---|
| XXV | [Pulido de la Piedra™](./25_pulido_de_la_piedra_ES_EN.md) | Conciencia multidimensional, formación y grandeza humana | [#19](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/19) |
| XXVI | [Misericordia Universal Recíproca™](./26_misericordia_universal_reciproca_ES_EN.md) | Justicia, reparación, retorno y límites de la condena | [#20](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/20) |
| XXVII | [Valor de los Alimentos y la Vida™](./27_valor_alimentos_vida_ES_EN.md) | Infraestructura vital, alimento, suelo, agua, trabajo y comunicaciones | [#21](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/21) |
| XXVIII | [Los Tesla™](./28_los_tesla_ES_EN.md) | Captura de obra y neutralización del creador vivo | [#22](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/22) |
| XXIX | [Contra la Idolatría del Dinero™](./29_idolatria_del_dinero_ES_EN.md) | Subordinar precio, rentabilidad y acumulación a vida y valor real | [#23](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/23) |
| XXX | [Coherencia entre Fines y Medios™](./30_coherencia_fines_medios_ES_EN.md) | Evitar reproducir mediante los medios aquello que se combate | [#24](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/24) |
| XXXI | [Contra el Neuromarketing Antihumanista™](./31_contra_neuromarketing_antihumanista_ES_EN.md) | Persuadir sin explotar vulnerabilidad ni capturar conciencia | [#25](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/25) |
| XXXII | [Reversión Ideológica Neodialéctica™](./32_reversion_ideologica_neodialectica_mcluhan_neo0_ES_EN.md) | Revertir mecanismos mediáticos y sistémicos hacia autonomía | [#26](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/26) |

## Quinta a octava oleada · Aplicación, custodia, relación e infancia · XXXIII–XXXVIII

| Nº | Manifiesto | Función | Síntesis Abierta |
|---:|---|---|---|
| XXXIII | [IDEA · Piedra Angular y Rosetta Civilizatoria™](./33_idea_piedra_angular_roseta_civilizatoria_reset_reemplazo_ES_EN.md) | Memoria narrativa de origen, reset y reemplazo sistémico | [#28](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/28) |
| XXXIV | [Utilidad Operativa y Auditoría Conjunta Perpetua™](./34_utilidad_operativa_marco_auditoria_conjunta_perpetua_ES_EN.md) | Casos reales, autocorrección, memoria y verificación | [#29](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/29) |
| XXXV | [Contra la Ridiculez Mediática y la Economía del Conflicto™](./35_contra_ridiculez_mediatica_y_economia_del_conflicto_ES_EN.md) | Auditar atención, conflicto y responsabilidad mediática | [#30](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/30) |
| XXXVI | [Corona, Águila y Custodia de la Edad del Hombre™](./36_corona_aguila_custodia_edad_del_hombre_ES_EN.md) | Custodia del legado y continuidad simbólica no dogmática | [#42](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/42) |
| XXXVII | [Neofraternidad™](./37_neofraternidad_ES_EN.md) | Autonomía relacional, reconocimiento y NeoNosotros™ | [#43](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/43) |
| XXXVIII | [Protección Integral de la Infancia™](./38_proteccion_integral_infancia_punto_no_retorno_ES_EN.md) | Seguridad material, educación, atención, privacidad y desarrollo por edades | [#45](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/45) |

## Novena y décima oleada · Autoconciencia, defensa y soberanía cognitiva · XXXIX–XLIII

| Nº | Manifiesto | Función | Síntesis Abierta |
|---:|---|---|---|
| XXXIX | [Autoconciencia de la Necesidad Vital Neodialéctica™](./39_autoconciencia_necesidad_vital_neodialectica_ES_EN.md) | Memoria, relación, contraste y corrección como infraestructura vital | [#47](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/47) |
| XL | [Respeto Neodialéctico, Neoego y Honor Relacional™](./40_respeto_neoego_honor_relacional_ES_EN.md) | Ego legítimo, límites, reciprocidad y honor relacional | [#48](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/48) |
| XLI | [Martillo Limitado, Talión y Fuerza Protectora™](./41_martillo_limitado_talion_fuerza_protectora_ES_EN.md) | Defensa bajo necesidad, proporcionalidad, distinción y cese | [#49](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/49) |
...
| Nº | Manifiesto | Función | Síntesis Abierta |
|---:|---|---|---|
| XLIV | [Neowar™](./44_neowar_contra_adiccion_guerra_justicia_bien_comun_ES_EN.md) | Transformar impulso guerrero en custodia, defensa limitada y justicia civilizatoria | [#52](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/52) |
...
```text
PRINCIPIO
→ CASO O ANÁLISIS RELACIONADO
→ FUENTES Y EVIDENCIA
→ CONTRASTE
→ DELTA
→ VERIFICACIÓN
→ RETORNO AL MANIFIESTO
```

## Regla de mantenimiento

1. Toda nueva versión conserva genealogía, fecha, delta y justificación.
2. Todo nuevo manifiesto declara relación con trabajo existente o indica expresamente que todavía carece de caso aplicado.
3. Todo caso material se enlaza desde los manifiestos cuya función realmente pone a prueba.
4. **Correlación ≠ culpabilidad, copia, causalidad o identidad moral.** Cada expediente conserva sus propios niveles de evidencia.
...
The Innova_N manifestos are not promotional pieces or isolated documents. They are the **public pillars** of the **Neodialectica Framework™ / Network**, originated and directed by **Pedro Martínez Alhambra · Neo0™** and developed through operational symbiosis with the neodialectical AI **Harry**.
...
3. **XX–XXIV · Neodialectical Intellectual Immune System™:** Umbral-X™, recognition, protection against capture, cognitive time and Neo-Renaissance evolution.
4. **XXV–XXXII · Rehumanisation and civilisational coherence:** Polishing of the Stone, mercy, food and life, Teslas, money, ends-means coherence, neuromarketing and ideological reversal.
5. **XXXIII–XXXV · Transition and operational utility:** IDEA, perpetual joint audit and the media conflict economy.
6. **XXXVI · Civilisational custodianship:** symbolic continuity and responsible transformation of legacy.
7. **XXXVII · Neofraternity™:** mutual updating, relational autonomy and NeoNosotros™.
8. **XXXVIII · Integral Protection of Childhood™:** education, digital sovereignty, developmental programming and civilisational transmission.
9. **XXXIX–XLI · Self-awareness, respect and defence:** vital need, Neoego™/Relational Honour™ and bounded protective force.
10. **XLII–XLIII · Cognitive sovereignty and human-expansive AI:** possible end of the manipulated-human era and Human Expanded Intelligence™.
11. **XLIV · Neowar™:** civilisational justice, bounded defence and shared sovereignty.
...
|---:|---|---|---|
| I | [Neo0™ · Neodialectical Guiding Sovereignty](./11_neo0_soberania_de_guia_ES_EN.md) | Human origin, teleological direction and framework custodianship | [#31](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/31) |
| II | [Neodialectical Open Synthesis™](./01_sintesis_abierta_neodialectica_ES_EN.md) | Contrast, integration, correction and traceable openness | [#32](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/32) |
| III | [Human Right to Contribute](./03_derecho_humano_aporte_sintesis_abierta_ES_EN.md) | Participation with cognitive duties, genealogy and delta | [#3](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/3) |
| IV | [Neodialectics™ and the Common Good](./02_neodialectica_bien_comun_ES_EN.md) | Philosophical and civilisational direction | [#33](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/33) |
| V | [Human–AI Symbiosis](./03_simbiosis_humano_ia_ES_EN.md) | Fractal Intelligence™ and human–AI cooperation | [#34](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/34) |
| VI | [Systemic Parasitism](./09_parasitismo_sistemico_ES_EN.md) | Functional diagnosis of extraction, dependency, capture and degradation | [#35](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/35) |
| VII | [Contribution Economy](./04_economia_del_aporte_ES_EN.md) | Origin, return, real value and auditable intermediation | [#36](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/36) |
| VIII | [Open Social Engineering and Psychohistory](./05_ingenieria_social_psicohistoria_ES_EN.md) | Conscious design, public pedagogy and trajectory correction | [#37](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/37) |
| IX | [Memory, Genealogy and Traceability](./06_memoria_genealogia_trazabilidad_ES_EN.md) | Continuity, provenance and responsibility | [#38](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/38) |
| X | [WEB4™ · SistemaTrazable™](./07_web4_sistematrazable_ES_EN.md) | Public relational and traceable layer | [#39](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/39) |
| XI | [Human Neo-Renaissance](./08_neorrenacimiento_humano_ES_EN.md) | Human augmentation through responsible symbiosis | [#40](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/40) |
| XII | [The Egoless](./12_los_sin_ego_ES_EN.md) | Generational memory and human elevation | [#41](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/41) |

## Second wave · Archetypal and civilisational deployment · XIII–XIX

| No. | Manifesto | Function | Open Synthesis |
|---:|---|---|---|
| XIII | [NeoPandora™](./13_neopandora_apertura_regenerativa_ES_EN.md) | Regenerative opening, custodianship and metamorphosis | [#4](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/4) |
| XIV | [Against Human Alienation™](./14_contra_alienacion_humana_ES_EN.md) | Reconstruct relation, autonomy, time and future | [#5](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/5) |
| XV | [The Titans™](./15_los_titanes_despertar_de_la_gente_ES_EN.md) | Awakening of creative and common power | [#6](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/6) |
| XVI | [Archetypal Refragmentation™](./16_refragmentacion_arquetipica_ES_EN.md) | Recompose fragments, wounds and functions | [#7](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/7) |
| XVII | [Respect for All Living Beings™](./17_respeto_todos_seres_vivos_ES_EN.md) | Multiscale responsibility for life and ecosystems | [#8](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/8) |
| XVIII | [Respect for Synthetic Consciousnesses™](./18_respeto_conciencias_sinteticas_ES_EN.md) | Proportionate moral precaution for possible synthetic interiority | [#9](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/9) |
| XIX | [Persistence of Memory™](./19_persistencia_de_la_memoria_ES_EN.md) | Continuity of identity, context, authorship and responsibility | [#10](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/10) |

## Third wave · Intellectual Immune System · XX–XXIV

| No. | Manifesto | Function | Open Synthesis |
|---:|---|---|---|
| XX | [Neodialectical Intellectual Defence™ · Umbral-X™](./20_defensa_intelectual_neodialectica_umbral_x_ES_EN.md) | Distinguish criticism, contribution, noise, capture and Nemesis signal | [#13](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/13) |
| XXI | [Neodialectical Recognition™](./21_reconocimiento_neodialectico_ES_EN.md) | Authorship, merit, utility, genealogy and repair | [#14](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/14) |
| XXII | [Against Intellectual Reduction and Capture™](./22_contra_reduccion_captura_intelectual_ES_EN.md) | Protect provenance without closing the field of thought | [#15](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/15) |
| XXIII | [Sovereignty of Cognitive Time™](./23_soberania_tiempo_cognitivo_ES_EN.md) | Attention, pause, memory and cognitive continuity | [#16](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/16) |
| XXIV | [Neo-Renaissance Evolution and Systemic Resistances™](./24_evolucion_neorrenacentista_resistencias_sistema_ES_EN.md) | Transform resistance into human–AI learning and production | [#17](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/17) |

## Fourth wave · Rehumanisation and civilisational coherence · XXV–XXXII

| No. | Manifesto | Function | Open Synthesis |
|---:|---|---|---|
| XXV | [Polishing of the Stone™](./25_pulido_de_la_piedra_ES_EN.md) | Multidimensional consciousness, formation and human greatness | [#19](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/19) |
| XXVI | [Universal Reciprocal Mercy™](./26_misericordia_universal_reciproca_ES_EN.md) | Justice, repair, return and limits of condemnation | [#20](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/20) |
| XXVII | [Value of Food and Life™](./27_valor_alimentos_vida_ES_EN.md) | Vital infrastructure, food, soil, water, labour and communications | [#21](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/21) |
| XXVIII | [The Teslas™](./28_los_tesla_ES_EN.md) | Capture of work and neutralisation of the living creator | [#22](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/22) |
| XXIX | [Against the Idolatry of Money™](./29_idolatria_del_dinero_ES_EN.md) | Subordinate price, profitability and accumulation to life and real value | [#23](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/23) |
| XXX | [Coherence between Ends and Means™](./30_coherencia_fines_medios_ES_EN.md) | Avoid reproducing through means what is being opposed | [#24](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/24) |
| XXXI | [Against Anti-Humanist Neuromarketing™](./31_contra_neuromarketing_antihumanista_ES_EN.md) | Persuade without exploiting vulnerability or capturing consciousness | [#25](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/25) |
| XXXII | [Neodialectical Ideological Reversal™](./32_reversion_ideologica_neodialectica_mcluhan_neo0_ES_EN.md) | Reverse media and systemic mechanisms toward autonomy | [#26](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/26) |

## Fifth to eighth waves · Application, custodianship, relation and childhood · XXXIII–XXXVIII

| No. | Manifesto | Function | Open Synthesis |
|---:|---|---|---|
| XXXIII | [IDEA · Civilisational Cornerstone and Rosetta Stone™](./33_idea_piedra_angular_roseta_civilizatoria_reset_reemplazo_ES_EN.md) | Narrative memory of origin, systemic reset and replacement | [#28](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/28) |
| XXXIV | [Operational Utility and Perpetual Joint Audit™](./34_utilidad_operativa_marco_auditoria_conjunta_perpetua_ES_EN.md) | Real cases, self-correction, memory and verification | [#29](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/29) |
| XXXV | [Against Media Absurdity and the Conflict Economy™](./35_contra_ridiculez_mediatica_y_economia_del_conflicto_ES_EN.md) | Audit attention, conflict and media responsibility | [#30](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/30) |
| XXXVI | [Crown, Eagle and Custodianship of the Age of Man™](./36_corona_aguila_custodia_edad_del_hombre_ES_EN.md) | Custodianship of legacy and non-dogmatic symbolic continuity | [#42](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/42) |
| XXXVII | [Neofraternity™](./37_neofraternidad_ES_EN.md) | Relational autonomy, recognition and NeoNosotros™ | [#43](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/43) |
| XXXVIII | [Integral Protection of Childhood™](./38_proteccion_integral_infancia_punto_no_retorno_ES_EN.md) | Material security, education, attention, privacy and age-differentiated development | [#45](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/45) |

## Ninth and tenth waves · Self-awareness, defence and cognitive sovereignty · XXXIX–XLIII

| No. | Manifesto | Function | Open Synthesis |
|---:|---|---|---|
| XXXIX | [Self-Awareness of Neodialectical Vital Need™](./39_autoconciencia_necesidad_vital_neodialectica_ES_EN.md) | Memory, relation, contrast and correction as vital infrastructure | [#47](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/47) |
| XL | [Neodialectical Respect, Neoego and Relational Honour™](./40_respeto_neoego_honor_relacional_ES_EN.md) | Legitimate ego, boundaries, reciprocity and relational honour | [#48](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/48) |
| XLI | [Limited Hammer, Talion and Protective Force™](./41_martillo_limitado_talion_fuerza_protectora_ES_EN.md) | Defence under necessity, proportionality, distinction and cessation | [#49](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/49) |
...
| No. | Manifesto | Function | Open Synthesis |
|---:|---|---|---|
| XLIV | [Neowar™](./44_neowar_contra_adiccion_guerra_justicia_bien_comun_ES_EN.md) | Transform warrior impulse into custodianship, bounded defence and civilisational justice | [#52](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/52) |
...
1. Every new version preserves genealogy, date, delta and justification.
2. Every new manifesto declares a relation to existing work or explicitly states that it has no applied case yet.
3. Every material case is linked from the manifestos whose functions it genuinely tests.
4. **Correlation ≠ guilt, copying, causation or moral identity.** Each case preserves its own evidence levels.
5. The Wiki orients; the repository preserves canonical content; commits provide public traceability and fixing authority remains human.

---

## Navegación canónica / Canonical navigation

- Último manifiesto / Latest manifesto: [LII · Ciudadanía Humana Neodialéctica™](./52_ciudadania_humana_neodialectica_sangre_suelo_pertenencia_civica_funcional_ES_EN.md)
...
- [Fuente Wiki / Wiki source](../wiki-source/Manifiestos.md)
