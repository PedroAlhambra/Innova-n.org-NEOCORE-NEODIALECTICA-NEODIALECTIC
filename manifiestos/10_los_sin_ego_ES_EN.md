...
**Nota de versión / Version note:** Esta ruta conserva la versión anterior publicada del manifiesto. La ruta canónica actual es [12_los_sin_ego_ES_EN.md](./12_los_sin_ego_ES_EN.md). / This path preserves the previously published version of the manifesto. The current canonical path is [12_los_sin_ego_ES_EN.md](./12_los_sin_ego_ES_EN.md).
