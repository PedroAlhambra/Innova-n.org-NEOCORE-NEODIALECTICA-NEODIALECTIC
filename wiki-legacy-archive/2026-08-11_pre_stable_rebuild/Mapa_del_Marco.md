...
Esta página referencia las principales superficies públicas sin duplicar sus contenidos. Cuando una sección cambia, manda su fuente canónica enlazada.
...
- [Manifiestos](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/manifiestos/README.md) — pilares públicos y navegación canónica.
- [Neoaxiomas™](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/neoaxiomas/README.md) — capa axiomática abierta y revisable.
- [Fragmentos históricos ES](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/tree/main/fragmentos) / [EN](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/tree/main/fragments) — memoria genealógica anterior y fuentes históricas.
- [Mapa manifiestos ↔ trabajo aplicado](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/manifiestos/RELACIONES_TRABAJO_APLICADO_ES_EN.md) — relaciones entre principios, casos, obras, análisis y auditorías.

## Síntesis y participación

- [Síntesis Abierta™](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/propuestas/sintesis-abierta/README.md) — índice operativo.
- [Índice completo de Síntesis Abiertas](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/propuestas/sintesis-abierta/INDICE_COMPLETO_SINTESIS_ABIERTAS_ES_EN.md) — nodos de contraste.
- [Cómo aportar](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/propuestas/sintesis-abierta/APORTAR_A_LA_SINTESIS_ES_EN.md) — protocolo general.
...
- [Análisis](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/analisis/README.md)
...
- [Serie pública](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/analisis/publicos/README.md)
- [Evidencias](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/analisis/publicos/evidencias/README.md)
...
- [Portal resumido de auditorías](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/AUDITORIAS_PUBLICAS.md)

## Obras, cultura y creación

- [Obras](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/obras/README.md)
- [IDEA](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/obras/idea/README.md)
- [UMBRAL-X · creación abierta](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/obras/umbral-x/README.md)

## Proyección pública y WEB4™
...
- [Anuncios y difusión](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/tree/main/anuncios)
- [innova-n.org](https://innova-n.org)

## Arquitectura técnica, automatización y trazabilidad

- [Configuración, scripts y workflows](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/tree/main/.github) — automatización documental, auditorías y sincronización.
- [Fuente versionada de esta Wiki](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/tree/main/wiki-source)
...
La Wiki referencia. Los índices canónicos enumeran. Los documentos desarrollan. Los commits conservan el cambio. Las Issues abren contradicción. Ninguna de estas superficies sustituye por sí sola al organismo completo.

---

# EN · English

This page references the principal public surfaces without duplicating their contents. When a section changes, its linked canonical source governs.
...
- [Open Synthesis™](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/propuestas/sintesis-abierta/README.md) — operational index.
- [Complete Open Synthesis index](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/propuestas/sintesis-abierta/INDICE_COMPLETO_SINTESIS_ABIERTAS_ES_EN.md) — challenge nodes.
- [How to contribute](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/propuestas/sintesis-abierta/APORTAR_A_LA_SINTESIS_ES_EN.md) — general protocol.
...
- [Analyses](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/analisis/README.md)
...
- [Public series](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/analisis/publicos/README.md)
- [Evidence](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/analisis/publicos/evidencias/README.md)
...
- [Audit summary portal](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/AUDITORIAS_PUBLICAS.md)

## Works, culture and creation

- [Works](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/obras/README.md)
- [IDEA](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/obras/idea/README.md)
- [UMBRAL-X · open creation](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/blob/main/obras/umbral-x/README.md)

## Public projection and WEB4™
...
## Technical architecture, automation and traceability

- [Configuration, scripts and workflows](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/tree/main/.github) — documentary automation, audits and synchronisation.
- [Versioned source of this Wiki](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/tree/main/wiki-source)
- [Commit history](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/commits/main)
- [Reference snapshot](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/tree/snapshot/neocore-7-current-2026-08-11)
