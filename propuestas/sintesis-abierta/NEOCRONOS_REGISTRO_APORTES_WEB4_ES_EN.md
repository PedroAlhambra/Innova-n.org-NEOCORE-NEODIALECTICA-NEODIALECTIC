...
**Recuperado / Recovered:** 2026-09-01 desde/from `sintesis-aportes-tokenizados` · blob histórico/historical `796da51237975100f3e528d35726f91e294d953a`.  
**Estado actual / Current state:** `HISTORICAL_RECOVERED / OPEN_OPERATIONAL_DESIGN / NOT_CURRENT_RUNTIME`.  
**Lectura vigente / Current reading:** este documento conserva la transición fundamental del modelo plano a `NC-EVT-* + NC-CR-*`. Debe leerse junto a la [versión vigente](../../versiones/README.md), la [propuesta de aporte auditable](./2026-09-01_DELTA_APORTE_AUDITABLE_PRIVACIDAD_TRAZABILIDAD_ES_EN.md) y los deltas posteriores de WEB4™. `TRAZA ≠ VALORACIÓN`, `DELTA ≠ CANON`, `APORTE_RECONOCIBLE => APORTE_AUDITABLE`. / This document preserves the fundamental transition from the flat model to `NC-EVT-* + NC-CR-*`. It must be read with the [current version](../../versiones/README.md), the [auditable-contribution proposal](./2026-09-01_DELTA_APORTE_AUDITABLE_PRIVACIDAD_TRAZABILIDAD_ES_EN.md), and later WEB4™ deltas. `TRACE ≠ VALUATION`, `DELTA ≠ CANON`, `RECOGNISABLE_CONTRIBUTION => AUDITABLE_CONTRIBUTION`.
