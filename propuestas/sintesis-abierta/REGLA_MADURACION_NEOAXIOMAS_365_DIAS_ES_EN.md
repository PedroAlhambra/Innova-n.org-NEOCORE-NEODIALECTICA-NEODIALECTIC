...
Cuenta como **respuesta sustantiva** una intervención que se dirija realmente a la formulación y aporte al menos uno de estos elementos:
...
- prueba o implementación que revele un límite relevante;
- apoyo razonado que contraste explícitamente la formulación.

No reinician ni satisfacen el plazo por sí solos:
...
- duplicados;
- spam;
- menciones sin contenido de contraste.
...
A **substantive response** is an intervention that genuinely addresses the formulation and contributes at least one of the following:
...
- test or implementation revealing a relevant limitation;
- reasoned support that explicitly scrutinises the formulation.

The following do not by themselves restart or satisfy the period:
...
- duplicates;
- spam;
- mentions without substantive scrutiny.
