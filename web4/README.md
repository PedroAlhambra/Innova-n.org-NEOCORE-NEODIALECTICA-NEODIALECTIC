...
3 minutos   → orientarse
30 minutos  → explorar rutas
profundidad → corpus y relaciones
acción      → aprender + crear + contrastar + aportar + sintetizar
```
...
3 minutes   → orient
30 minutes  → explore routes
depth       → corpus and relations
