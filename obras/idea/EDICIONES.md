# IDEA · Ediciones internacionales / International Editions
...
## Obra y genealogía / Work and genealogy

**IDEA** fue escrita entre 1997 y 2002. Una versión con leves cambios fue presentada al **Premio UPC de Ciencia Ficción en 2002**. Su primera edición pública apareció en 2026 mediante una **restauración conservadora**.

IDEA antecede históricamente a Neodialéctica™, Innova_N, NEOCore™, SAN™, NAVE™ y WEB4™. Actualmente funciona como puerta narrativa de entrada al marco, sin que esa función modifique su genealogía.

**IDEA** was written between 1997 and 2002. A version containing minor changes was submitted to the **UPC Science Fiction Award in 2002**. Its first public edition appeared in 2026 through a **conservative restoration**.

IDEA historically predates Neodialectics™, Innova_N, NEOCore™, SAN™, NAVE™ and WEB4™. It now functions as a narrative gateway into the framework, without that present function altering its genealogy.
...
# Estado editorial / Publishing status
...
# Criterio de registro / Record criterion

El ASIN incluido para cada idioma funciona como **identificador público de referencia** de esa edición lingüística. No implica que todos los formatos compartan el mismo ASIN.

The ASIN listed for each language functions as the **public reference identifier** for that language edition. It does not imply that every format shares the same ASIN.

Los enlaces con ASIN utilizan el patrón limpio `https://www.amazon.es/dp/ASIN`, sin parámetros de seguimiento o sesión. El enlace polaco se conserva como enlace corto confirmado porque no existe un ASIN verificado en el registro.

Links with an ASIN use the clean pattern `https://www.amazon.es/dp/ASIN`, without tracking or session parameters. The Polish short link is retained because no verified ASIN exists in the record.

---

# Navegación / Navigation

* [IDEA · página principal / Main page](./README.md)
