...
```text
FUEGO
→ transformación · energía · impulso · creación · destrucción posible

AGUA
→ continuidad · adaptación · memoria · regulación · dispersión posible
...
- **Tierra™** → materia, límite, biosfera, soporte, territorio, realidad compartida y condición material;
...
→ PUERTA DE LECTURA
→ NO LÍMITE ONTOLÓGICO

TOTALIDAD ELEMENTAL™
=
TODO LO CONOCIDO
+ TODO LO RELACIONABLE
+ APERTURA A LO TODAVÍA DESCONOCIDO
+ TRAZABILIDAD
+ SÍNTESIS
```
