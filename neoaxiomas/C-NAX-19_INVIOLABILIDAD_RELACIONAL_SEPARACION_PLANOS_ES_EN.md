# C-NAX-19 · Inviolabilidad Relacional y Separación de Planos™
# C-NAX-19 · Relational Inviolability and Separation of Planes™
...
**Separación de Planos:** `FANTASÍA ≠ REALIDAD · DESEO ≠ DERECHO · ROL ≠ IDENTIDAD TOTAL · EXCITACIÓN ≠ CONSENTIMIENTO · PODER ≠ PERMISO · ACCESO ≠ DISPONIBILIDAD · RELACIÓN ≠ PROPIEDAD`.

**En sencillo:** Tener deseo, afecto, autoridad, acceso o una relación con otra persona no crea un derecho sobre ella. La legitimidad de la relación depende de dignidad, consentimiento válido, posibilidad real de negarse o salir y mayor responsabilidad cuando existe más poder.

**Ejemplo:** La dependencia laboral de una persona respecto de su responsable no convierte esa dependencia en consentimiento para una relación personal. Si existe una asimetría de poder, debe aumentar el cuidado para que un sí sea realmente libre y un no no produzca represalias.
...
**Separation of Planes:** `FANTASY ≠ REALITY · DESIRE ≠ RIGHT · ROLE ≠ TOTAL IDENTITY · AROUSAL ≠ CONSENT · POWER ≠ PERMISSION · ACCESS ≠ AVAILABILITY · RELATIONSHIP ≠ OWNERSHIP`.

**In plain language:** Desire, affection, authority, access or an existing relationship with another person does not create a right over that person. A legitimate relationship depends on dignity, valid consent, a real ability to refuse or leave, and greater responsibility where greater power exists.

**Example:** An employee’s dependence on a manager does not turn that dependence into consent to a personal relationship. Where a power asymmetry exists, safeguards must increase so that yes is genuinely free and no does not lead to retaliation.

**Procedencia / Provenance:** [LXIX](../manifiestos/69_defensa_inocencia_humana_asimetria_protectora_deber_custodia_ES_EN.md) + [LXX](../manifiestos/70_fauno_masculinidad_fragmentada_depredacion_relacional_retorno_hombre_ES_EN.md) + [LXXI](../manifiestos/71_libertad_sexual_hipersexualizacion_industrial_separacion_planos_ES_EN.md) + [LXXII](../manifiestos/72_hombre_custodio_fuerza_deseo_poder_responsabilidad_ES_EN.md).  
**Síntesis / Synthesis:** [#123](https://github.com/PedroAlhambra/Innova-n.org-NEOCORE-NEODIALECTICA-NEODIALECTIC/issues/123).
