...
**Marco / Framework:** Innova_N · Neodialéctica™ · NEOCore™ · WEB4™ · Síntesis Abierta™ / Neodialectics™ · Open Synthesis™  
...
Review the repository's public layer as a related system and correct an accumulated problem: the manifestos had grown faster than the explicit links among **principles**, **analyses**, **audits**, **cases**, **works**, **protocols**, **evidence** and **Open Syntheses**.

The purpose is not to turn every manifesto into a giant index, but to build two-dimensional navigation:
...
The integral reading of the public layer relied especially on:

- Manifestos I–XLVII;
- the canonical manifesto index;
- the Open Synthesis index and protocol;
- `analisis/INDEX.md` and `analisis/publicos/README.md`;
- public audits;
- the Spain–Morocco series;
- the KDP/Author Central/IDEA and DistroKid–Spotify case files;
- analyses on the attention economy, institutional AI, Stanford/ACE, LinkedIn, religion/identity and child protection;
- `obras/idea/README.md`;
- the Oracle/fragment index;
- the Distributed Neodialectical Projection Protocol™;
- and `wiki-source/Manifiestos.md`.

This pass does not claim that every historical file in the repository was rewritten or reread line by line. The review concentrates on canonical nodes and work families that materially test the principles.

## 3. Main structural finding

The repository contained a **canonical synchronisation drift**:

- Manifestos already existed through **XLVII**;
- the manifesto index still declared **I–XLV** and an incomplete wave taxonomy;
- the Open Synthesis index still declared lower coverage;
- other peripheral README files retain historical references or earlier counters.

This pass corrected the two canonical navigation indexes:

1. `manifiestos/README.md` → **47 manifestos · I–XLVII · 14 waves**;
2. `propuestas/sintesis-abierta/README.md` → **47 manifestos · I–XLVII** and their current Issues.

Synchronising counters across all peripheral README files remains separate from this operation so that large files are not replaced without a dedicated comparison and postcheck pass.
...
The matrix covers **I–XLVII** and classifies each relation as:

- **A · direct application or audit**;
- **B · structural analysis**;
- **C · documentary, genealogical or symbolic relation**.

The matrix allows a reader arriving from a manifesto to find work that develops or tests it without having to know the folder structure beforehand.

## 5. Extraction and parasitism core

The strongest correlation appears among:
...
And the applied families:

- attention economy → contribution economy;
- DistroKid–Spotify;
- KDP–Author Central–IDEA;
- AI/Stanford precedence and convergence;
- procurement, guardianship and institutional dependency in the Canary Islands.

Manifestos materially coupled to these cases now include `Applied work and related cases` blocks with relative internal links.

## 6. Evidence discipline

The relational layer incorporates explicit limits to prevent a link from producing a stronger accusation than the source supports:
...
FUNCTIONAL PATTERN
≠ MORAL IDENTITY OF A PERSON OR GROUP

OPEN CASE
≠ PENAL OR INTENTIONAL CONCLUSION
```

Concrete applications:

- the DistroKid–Spotify case remains open and is not presented as automatic proof of deliberate royalty diversion;
- Stanford/ACE and institutional AI convergence preserve precedence and similarities, not proof of direct copying;
- the Canary Islands analysis studies procurement, guardianship, concentration and control without labelling people or entities as “parasites”;
- the Child Point of No Return™ remains a measurable-threshold hypothesis, not an already proven state;
- the Spain–Morocco case files preserve separation among facts, hypotheses and unproven political connections.

## 7. Manifestos with direct applied links added in this pass

Compact blocks were added without changing internal numbering or inserting material inside the doctrinal body of:
...
- XXVIII · The Teslas;
- XXIX · Against the Idolatry of Money;
- XXXI · Against Antihumanist Neuromarketing;
- XXXIV · Operational Utility and Perpetual Joint Audit;
- XXXVIII · Integral Protection of Childhood.

For the remainder, the relation is available through the transversal matrix. This decision avoids replicating dozens of links in every file and preserves the manifesto body as a readable document.
...
├─ Open Synthesis
├─ direct applied work when the relation is material
...
The Wiki continues to serve only an orientation function. `wiki-source/Manifiestos.md` points to the index and transversal map without copying the matrices.

## 9. Proposed and applied maintenance rule

From this pass onward:

1. a new manifesto should declare a real relation to existing work or indicate that it still lacks an applied case;
2. a new material case should be incorporated into the map and linked directly from the manifestos whose function it genuinely tests;
3. a case is not linked merely because it shares vocabulary;
4. every relation preserves the evidentiary level of the case file;
5. the Wiki does not duplicate the matrix;
6. commits preserve technical precedence and canonical fixing remains human.

## 10. Detected pending work

The integral reading detects one pending matter independent of correlation: some **peripheral README files and cover surfaces** still show counters or ranges predating XLVII. They were not mass-replaced in this pass to avoid breaking extensive files without complete comparison.

The canonical manifesto index and Open Synthesis index are already normalised to I–XLVII. A later surface-synchronisation pass should be limited to counters, access and navigation, without rewriting historical content.
