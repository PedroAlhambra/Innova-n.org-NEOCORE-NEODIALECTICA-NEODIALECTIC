...
- Enlaces Markdown internos comprobados: **746**.
- README actualizados con bloque canónico de navegación y procedencia: **12**.
- Enlaces internos rotos detectados tras la actualización: **0**.
- Requisitos faltantes en `manifiestos/README.md`: **0**.
...
- Ninguno detectado por el validador de rutas relativas.

### Estado del índice de manifiestos
...
- Internal Markdown links checked: **746**.
