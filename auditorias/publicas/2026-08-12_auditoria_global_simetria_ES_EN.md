...
- `analisis/publicos/2026-08-08_accesibilidad_institucional_escalado_ciudadano_jefaturas_estado_ES_EN.md` · ES=807 · EN=774 · ratio=0.96
  - 8: párrafos ES=5 EN=4
- `analisis/publicos/2026-08-08_addendum_autodemostracion_creacion_neodialectica_historia_olvidada_ES_EN.md` · ES=656 · EN=657 · ratio=1.00
...
- `analisis/publicos/2026-08-08_techno_bach_record_semanal_apple_music_ES_EN.md` · ES=335 · EN=348 · ratio=1.04
  - 5: párrafos ES=3 EN=4
...
- `anuncios/2026-08-06_ALGORITMO_EUROPEO_PENSAMIENTO_REFLEXIVO_SINTESIS_ABIERTA_ES_EN.md` · ES=330 · EN=328 · ratio=0.99
  - Participa: párrafos ES=2 EN=1
- `anuncios/2026-08-06_SEGUNDA_OLEADA_MANIFIESTOS_NEOPANDORA_ES_EN.md` · ES=279 · EN=275 · ratio=0.99
  - Leer y participar: párrafos ES=2 EN=1
- `anuncios/2026-08-06_TERCERA_OLEADA_SISTEMA_INMUNITARIO_INTELECTUAL_ES_EN.md` · ES=362 · EN=350 · ratio=0.97
...
- `manifiestos/63_contra_simplificacion_burda_marco_fidelidad_compresion_ES_EN.md` · ES=1120 · EN=1141 · ratio=1.02
  - Vínculos internos: párrafos ES=1 EN=0
- `manifiestos/64_neocronos_tokenizacion_aporte_sintesis_abierta_ES_EN.md` · ES=838 · EN=813 · ratio=0.97
  - 14: párrafos ES=2 EN=1
- `manifiestos/65_neojuego_bien_comun_tokenizado_honor_aporte_ES_EN.md` · ES=912 · EN=910 · ratio=1.00
  - 14: párrafos ES=2 EN=1
...
- `manifiestos/RELACIONES_LVII_LIX_ES_EN.md` · ES=611 · EN=611 · ratio=1.00
  - Secuencia transversal: párrafos ES=2 EN=1
...
- `propuestas/sintesis-abierta/2026-08-11_DELTA_HUMANIDAD_COMUN_MADURACION_INVERTIDA_TROL_BOT_MAL_SISTEMICO_ES_EN.md` · ES=859 · EN=834 · ratio=0.97
  - 22: párrafos ES=1 EN=2
- `propuestas/sintesis-abierta/2026-08-15_DELTA_NEOMANTIS_ASIMETRIA_INVERTIDA_DIGNIDAD_RECIPROCA_ES_EN.md` · ES=895 · EN=899 · ratio=1.00
  - 12: párrafos ES=1 EN=0
...
- `wiki-source/Aportes_y_Reconocimiento.md` · ES=259 · EN=249 · ratio=0.96
  - Fuentes públicas relacionadas: párrafos ES=1 EN=0
...
- `wiki-source/NeoGenealogia.md` · ES=307 · EN=282 · ratio=0.92
  ...
  - Fuentes canónicas: párrafos ES=1 EN=0
- `wiki-source/Neoaxiomas.md` · ES=110 · EN=104 · ratio=0.95
  - Regla: párrafos ES=1 EN=0
- `wiki-source/Obras_y_Cultura.md` · ES=144 · EN=136 · ratio=0.94
  - Hacia WEB4™: párrafos ES=2 EN=1
- `wiki-source/Participar.md` · ES=165 · EN=170 · ratio=1.03
  - Regla de reciprocidad: párrafos ES=2 EN=1
- `wiki-source/Procedencia_Trazabilidad_y_Legal.md` · ES=147 · EN=140 · ratio=0.95
  - Capa pública y capa protegida: párrafos ES=3 EN=2
- `wiki-source/RADAR_PI.md` · ES=149 · EN=152 · ratio=1.02
...
| `analisis/publicos/2026-08-07_parte-iv-canarias-quorum-tutela-contratacion-control-politico_ES_EN.md` | **REVISAR** | 12: lists ES=0 EN=12; 12: párrafos ES=7 EN=10 |
| `analisis/publicos/2026-08-07_spotify_distrokid_cierre_circular_y_escalado_ES_EN.md` | **REVISAR** | 5: párrafos ES=3 EN=5 |
| `analisis/publicos/2026-08-07_spotify_respuesta_generica_distrokid_cierre_circular_ES_EN.md` | **REVISAR** | 6: párrafos ES=1 EN=3 |
...
| `analisis/publicos/2026-08-08_techno_bach_record_semanal_apple_music_ES_EN.md` | **REVISAR** | 5: párrafos ES=3 EN=4 |
| `analisis/publicos/2026-08-08_umbral_x_maxproc_001_leonidas_cancerbero_streaming_trazabilidad_ES_EN.md` | **REVISAR** | 7: párrafos ES=3 EN=4 |
...
| `auditorias/publicas/2026-08-08_auditoria_oneshots_github_actions_carreras_noop_y_estado_final_ES_EN.md` | **REVISAR** | 10: párrafos ES=3 EN=4 |
...
| `auditorias/publicas/2026-08-11_postcheck_LXIX_LXXII_C_NAX_19_navegacion_paridad_ES_EN.md` | **REVISAR** | 14: párrafos ES=4 EN=3 |
| `auditorias/publicas/2026-08-11_postcheck_LXXIII_LXXIV_C_NAX_20_21_ES_EN.md` | **REVISAR** | 15: párrafos ES=1 EN=0 |
...
| `auditorias/publicas/ISSUES_AUDITORIAS_PUBLICAS_ES_EN.md` | **REVISAR** | Abrir una auditoría nueva: párrafos ES=3 EN=4 |
...
| `manifiestos/65_neojuego_bien_comun_tokenizado_honor_aporte_ES_EN.md` | **REVISAR** | 14: párrafos ES=2 EN=1 |
| `manifiestos/66_neosinergia_neowar_activa_medici_leonidas_cancerbero_ES_EN.md` | **REVISAR** | 14: párrafos ES=2 EN=1 |
...
| `propuestas/sintesis-abierta/2026-08-15_DELTA_NEOMANTIS_ASIMETRIA_INVERTIDA_DIGNIDAD_RECIPROCA_ES_EN.md` | **REVISAR** | 12: párrafos ES=1 EN=0 |
...
| `wiki-source/Participar.md` | **REVISAR** | Regla de reciprocidad: párrafos ES=2 EN=1 |
| `wiki-source/Procedencia_Trazabilidad_y_Legal.md` | **REVISAR** | Capa pública y capa protegida: párrafos ES=3 EN=2 |
